...
class Data_charge(models.Model):
    user_id = models.IntegerField(verbose_name="id_Username",null = False,default=0)
    ...
    date_of_debit = models.DateField(verbose_name="time_of_debit",null = False)
    day_of_debit = models.IntegerField(verbose_name="date_of_debit",null=False)
    ...
    is_fraud = models.BinaryField(verbose_name="is_fraud",null = False,default=0)
